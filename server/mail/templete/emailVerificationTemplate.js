const otpTemplate = (otp) => {
	...
	<body>
		<div className="container">
			...
			<div className="body">
				<p>Dear User,</p>
				<p>Thank you for registering with Insight-Ed. To complete your registration, please use the following OTP
			...
			<div className="support">If you have any questions or need assistance, please feel free to reach out to us at <a
					href="mailto:info@Insight-Ed.com">info@Insight-Ed.com</a>. We are here to help!</div>
		</div>
	</body>
